...
foreach(_expectedTarget iceoryx_posh::iceoryx_posh iceoryx_posh::iceoryx_posh_roudi iceoryx_posh::iceoryx_posh_gateway iceoryx_posh::iceoryx_posh_config iceoryx_posh::iox-roudi)
...
set(_IMPORT_PREFIX "/home/hua/workspace/adaptive_autosar/ModSar/external/iceoryx_lib")
...
set_target_properties(iceoryx_posh::iceoryx_posh PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/iceoryx/v2.90.0"
...
file(GLOB CONFIG_FILES "${_DIR}/iceoryx_poshTargets-*.cmake")
...
foreach(_target "iceoryx_hoofs::iceoryx_hoofs" "iceoryx_dust::iceoryx_dust" )
